...
import { applyStuckSafety } from '../ai/bot/safety/stuck';
import { executeRope as executeRope0, tryAttachRope as tryAttachRope0 } from '../ai/bot/movement/rope';
...
export class BotTurnController {
  ...
  public ropeMode: RopeMode | null = null;
  ...
  public ropeStallCount: number = 0;
  ...
  private executeMovement(
    ...
    if (applyStuckSafety(this as any, { presenter, player, dir, now, obstacle, ceilingLow })) return true;
  ...
  private tryAttachRope(
    ...
    return tryAttachRope0(this as any, presenter, player, moveTo, dir, ropeBudget, now, strategy);
  }
  ...
  private executeRope(
    ...
    executeRope0(this as any, presenter, player, moveTo, dir, now, dt);
  }
